...
Tchaud=100 # la température la plus chaude dans le barreau
...
Tini=np.ones(ne)*20; #  array([1.0, 1.0, ..., 1.0])*20
Tini[45:54]=Tchaud
...
Tavant=Tini
Tapres=np.zeros(ne) #  array([0., 0., ..., 0.])
...
for i in range(0, Nt-1):  
    ...
    Tapres[-1] = 20;  Tapres[0] = 20;  Tapres[45:54] = Tchaud##

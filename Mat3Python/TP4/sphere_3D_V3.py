...
titre=mat+', VolumeVersion='+str(volumeVersion)+', dt='+str(dt)+', n='+str(n)+',\n F='+str(round(F,4))+', Bi='+str(round(Bi,5))
...
plt.tight_layout()
plt.savefig(titre+'.pdf',dpi=50,format='pdf',transparent=False)
